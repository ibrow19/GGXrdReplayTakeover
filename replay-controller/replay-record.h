...
private:
    ...
    // longer than 99 seconds. Conservatively we'll add 10 seconds to the
    ...
    // buffer.
    static constexpr size_t MaxRoundFrames = 5940 + 600;
    static constexpr size_t SaveStateSpacing = 24;
